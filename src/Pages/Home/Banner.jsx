...
import img1 from "../../assets/carouselimg/image 111.jpg";
import img2 from "../../assets/carouselimg/image 222.webp";
  ...
  return (
    <Carousel>
      <div className="relative flex items-center justify-center min-h-screen">
        <img src={img1} alt="Apple TV" className="w-full object-cover" />
        <div className="absolute inset-0 flex flex-col items-center justify-center bg-black bg-opacity-50 text-white space-y-4">
          <h2 className="text-2xl font-bold text-center">
            A Hands-On Look at the New Apple TV
          </h2>
      ...
      <div className="relative flex items-center justify-center min-h-screen">
        <img src={img2} alt="Apple TV" className="w-full object-cover" />
        <div className="absolute inset-0 flex flex-col items-center justify-center bg-black bg-opacity-50 text-white space-y-4">
          <h2 className="text-2xl font-bold text-center">
